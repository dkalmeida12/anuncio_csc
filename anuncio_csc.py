...
Original file is located at
    https://colab.research.google.com/drive/1nEES4BBMu79lrAcBJv6ms8SValXJGt9g
"""
...
print("=" * 60)
print("GERADOR DE ANÚNCIO DE PRESENÇA CSC-PM v3.2")
print("=" * 60)

# Carregar efetivo
df_efetivo = pd.read_csv(StringIO(EFETIVO_CSC))

# Upload do formulário
print("\n📋 FAÇA O UPLOAD DA PLANILHA DO GOOGLE FORMULÁRIOS (XLS/XLSX):")
uploaded_form = files.upload()
form_file = list(uploaded_form.keys())[0]

# Leitura do formulário
print("\n📊 Processando dados...")
df_formulario = pd.read_excel(form_file)
...
if df_hoje.empty:
    ...
    print("Verifique se a 'Data do anúncio' no formulário corresponde à data de hoje.")
else:
...
if militares_nao_informados:
    print("\n" + "=" * 60)
    print("❌ MILITARES QUE NÃO RESPONDERAM:")
    print("=" * 60)
    for militar in militares_nao_informados:
        print(f"   • {militar}")
    print(f"\n❌ Total de {len(militares_nao_informados)} militar(es) faltando no anúncio.")

with open('anuncio_presenca.txt', 'w', encoding='utf-8') as f:
    f.write(anuncio)
    if militares_nao_informados:
        f.write("\n\n" + "=" * 60 + "\n")
        f.write("❌ MILITARES QUE NÃO RESPONDERAM:\n")
        f.write("=" * 60 + "\n")
        for militar in militares_nao_informados:
            f.write(f"   • {militar}\n")

print("\n✅ Anúncio salvo em 'anuncio_presenca.txt'")
print("\n💾 Fazendo download do arquivo...")
files.download('anuncio_presenca.txt')
